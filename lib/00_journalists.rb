# This file contains the code regarding the first exercise link to the twitter handle of journalist

#my array will be call handle for handle twitter
...
#First Method providing an answer to this question : "Combien y a-t-il de handle dans cette array ?"
def count_handle(nbr_handle)
	# method use to count the number of handle
	# Variable (nbr_handle) will be link to the table handle when i will call the method
	return nbr_handle.length
end
...
def shortest_handle(small_handle)
	smallest = small_handle.sort_by { |x| x.length }
	smallest = smallest[0]
end
